            ...
            <section className="contact-container container">
                ...
                <div className="get_form_inner">
                    ...
                    <form ref={form} onSubmit={sendEmail}>
                        ...
                        <div className="disclaimer">
                              <p>Clean Start Group needs the contact information you provide to us to contact you about our products and services. You may unsubscribe from these communications at any time. For information on how to unsubscribe, as well as our privacy practices and commitment to protecting your privacy, please review our  
                ...
                <div className="contact-cards-container">
                        ...
                        <div className="get_form_inner2">
                            <h2>CALL US</h2>
                            <p>
                                <AiOutlinePhone /> <a href="tel:3234100211"> +1 (323) 410-0211</a><br />
                            </p>
                        ...
                        <div className="get_form_inner2 card_email">
                            <h2>EMAIL</h2>
                            <p><AiOutlineMail /> Info@CleanStartGroup.com</p>
                        </div>
